    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="update.php" method="post" enctype="multipart/form-data">
              ...
              <div>  <label for="">id category</label>
                    <input value="<?= $bookings[0]->id_cat; ?>" 
                        name="id_cat" type="number" class="form-control" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="margin-top: 15px;">
                    ...
                    <textarea name="descr" id="descr" class="form-control" cols="30" rows="5"
                        ...
                        required><?= $bookings[0]->des; ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input value="<?= $bookings[0]->id_cat; ?>"
                        id="password" name="id_cat" type="number" class="form-control"
                        placeholder="Enter 6 Charectar Password"  required>
                </div>
